          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <motion.div variants={reveal}>
              ...
              <p className="text-gray-600 mb-6">
                We combineren lokale kennis met digitale expertise. Of je nu
                midden in {fm.city} zit of in de randgemeenten, we begrijpen de
                doelgroep en vertalen dat naar performante UX, sterke content en
                meetbare resultaten.
              </p>
              <a
                href="/portfolio"
